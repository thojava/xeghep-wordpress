			...
			?>
				...
				<div class="hotline <?php if($shake_hotline_pos==2){ echo 'hotline-on-right'; } ?>">
					<div id="phonering-alo-phoneIcon" class="phonering-alo-phone phonering-alo-green phonering-alo-show">
                    	<span class="number"><a href="tel:<?php echo esc_attr($shake_hotline); ?>"><i class="fas fa-caret-left"></i><?php echo esc_attr($shake_hotline); ?></a></span>
						<div class="phonering-alo-ph-circle"></div>
						<div class="phonering-alo-ph-circle-fill"></div>
						<div class="phonering-alo-ph-img-circle">
							<a class="pps-btn-img " href="tel:<?php echo esc_attr($shake_hotline); ?>"></a>
						</div>
					</div>
				</div>
			<?php
