...
;// CONCATENATED MODULE: ./src/admin/hooks/use-update-title.js

/* harmony default export */ const use_update_title = (function () {
...
;// CONCATENATED MODULE: ./src/admin/pages/getting-started/index.js
...
/* harmony default export */ const getting_started = (function () {
  ...
  use_update_title((0,external_wp_i18n_namespaceObject.__)('BlockArt Blocks - Getting started', 'blockart'));
...
var W=e=>typeof e=="function",T=(e,t)=>W(e)?e(t):e;var U=(()=>{let e=0;return()=>(++e).toString()})(),dist_b=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");e=!t||t.matches}return e}})();var Q=20;var S=new Map,X=1e3,$=e=>{if(S.has(e))return;let t=setTimeout(()=>{S.delete(e),dist_u({type:4,toastId:e})},X);S.set(e,t)},J=e=>{let t=S.get(e);t&&clearTimeout(t)},v=(e,t)=>{switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,Q)};case 1:return t.toast.id&&J(t.toast.id),{...e,toasts:e.toasts.map(r=>r.id===t.toast.id?{...r,...t.toast}:r)};case 2:let{toast:o}=t;return e.toasts.find(r=>r.id===o.id)?v(e,{type:1,toast:o}):v(e,{type:0,toast:o});case 3:let{toastId:s}=t;return s?$(s):e.toasts.forEach(r=>{$(r.id)}),{...e,toasts:e.toasts.map(r=>r.id===s||s===void 0?{...r,visible:!1}:r)};case 4:return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(r=>r.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let a=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(r=>({...r,pauseDuration:r.pauseDuration+a}))}}},A=[],P={toasts:[],pausedAt:void 0},dist_u=e=>{P=v(P,e),A.forEach(t=>{t(P)})},Y={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},I=(e={})=>{let[t,o]=(0,external_React_namespaceObject.useState)(P);(0,external_React_namespaceObject.useEffect)(()=>(A.push(o),()=>{let a=A.indexOf(o);a>-1&&A.splice(a,1)}),[t]);let s=t.toasts.map(a=>{var r,c;return{...e,...e[a.type],...a,duration:a.duration||((r=e[a.type])==null?void 0:r.duration)||(e==null?void 0:e.duration)||Y[a.type],style:{...e.style,...(c=e[a.type])==null?void 0:c.style,...a.style}}});return{...t,toasts:s}};var G=(e,t="blank",o)=>({createdAt:Date.now(),visible:!0,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...o,id:(o==null?void 0:o.id)||U()}),dist_h=e=>(t,o)=>{let s=G(t,e,o);return dist_u({type:2,toast:s}),s.id},dist_n=(e,t)=>dist_h("blank")(e,t);dist_n.error=dist_h("error");dist_n.success=dist_h("success");dist_n.loading=dist_h("loading");dist_n.custom=dist_h("custom");dist_n.dismiss=e=>{dist_u({type:3,toastId:e})};dist_n.remove=e=>dist_u({type:4,toastId:e});dist_n.promise=(e,t,o)=>{let s=dist_n.loading(t.loading,{...o,...o==null?void 0:o.loading});return e.then(a=>(dist_n.success(T(t.success,a),{id:s,...o,...o==null?void 0:o.success}),a)).catch(a=>{dist_n.error(T(t.error,a),{id:s,...o,...o==null?void 0:o.error})}),e};var Z=(e,t)=>{dist_u({type:1,toast:{id:e,height:t}})},ee=()=>{dist_u({type:5,time:Date.now()})},D=e=>{let{toasts:t,pausedAt:o}=I(e);(0,external_React_namespaceObject.useEffect)(()=>{if(o)return;let r=Date.now(),c=t.map(i=>{if(i.duration===1/0)return;let d=(i.duration||0)+i.pauseDuration-(r-i.createdAt);if(d<0){i.visible&&dist_n.dismiss(i.id);return}return setTimeout(()=>dist_n.dismiss(i.id),d)});return()=>{c.forEach(i=>i&&clearTimeout(i))}},[t,o]);let s=(0,external_React_namespaceObject.useCallback)(()=>{o&&dist_u({type:6,time:Date.now()})},[o]),a=(0,external_React_namespaceObject.useCallback)((r,c)=>{let{reverseOrder:i=!1,gutter:d=8,defaultPosition:p}=c||{},g=t.filter(m=>(m.position||p)===(r.position||p)&&m.height),E=g.findIndex(m=>m.id===r.id),x=g.filter((m,R)=>R<E&&m.visible).length;return g.filter(m=>m.visible).slice(...i?[x+1]:[0,x]).reduce((m,R)=>m+(R.height||0)+d,0)},[t]);return{toasts:t,handlers:{updateHeight:Z,startPause:ee,endPause:s,calculateOffset:a}}};var oe=h`
from {
...
to {
  ...
  animation: ${Te} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,M=({toast:e})=>{let{icon:t,type:o,iconTheme:s}=e;return t!==void 0?typeof t=="string"?external_React_namespaceObject.createElement(fe,null,t):t:o==="blank"?null:external_React_namespaceObject.createElement(le,null,external_React_namespaceObject.createElement(V,{...s}),o!=="loading"&&external_React_namespaceObject.createElement(ue,null,o==="error"?external_React_namespaceObject.createElement(_,{...s}):external_React_namespaceObject.createElement(w,{...s})))};var ye=e=>`
...
`,Ae=(e,t)=>{let s=e.includes("top")?1:-1,[a,r]=dist_b()?[he,xe]:[ye(s),ge(s)];return{animation:t?`${h(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${h(r)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},F=external_React_namespaceObject.memo(({toast:e,position:t,style:o,children:s})=>{let a=e.height?Ae(e.position||t||"top-center",e.visible):{opacity:0},r=external_React_namespaceObject.createElement(M,{toast:e}),c=external_React_namespaceObject.createElement(Se,{...e.ariaProps},T(e.message,e));return external_React_namespaceObject.createElement(be,{className:e.className,style:{...a,...o,...e.style}},typeof s=="function"?s({icon:r,message:c}):external_React_namespaceObject.createElement(external_React_namespaceObject.Fragment,null,r,c))});m(external_React_namespaceObject.createElement);var Ee=({id:e,className:t,style:o,onHeightUpdate:s,children:a})=>{let r=external_React_namespaceObject.useCallback(c=>{if(c){let i=()=>{let d=c.getBoundingClientRect().height;s(e,d)};i(),new MutationObserver(i).observe(c,{subtree:!0,childList:!0,characterData:!0})}},[e,s]);return external_React_namespaceObject.createElement("div",{ref:r,className:t,style:o},a)},Re=(e,t)=>{let o=e.includes("top"),s=o?{top:0}:{bottom:0},a=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:dist_b()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(o?1:-1)}px)`,...s,...a}},ve=u`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,O=16,Ie=({reverseOrder:e,position:t="top-center",toastOptions:o,gutter:s,children:a,containerStyle:r,containerClassName:c})=>{let{toasts:i,handlers:d}=D(o);return external_React_namespaceObject.createElement("div",{style:{position:"fixed",zIndex:9999,top:O,left:O,right:O,bottom:O,pointerEvents:"none",...r},className:c,onMouseEnter:d.startPause,onMouseLeave:d.endPause},i.map(p=>{let g=p.position||t,E=d.calculateOffset(p,{reverseOrder:e,gutter:s,defaultPosition:t}),x=Re(g,E);return external_React_namespaceObject.createElement(Ee,{id:p.id,key:p.id,onHeightUpdate:d.updateHeight,className:p.visible?ve:"",style:x},p.type==="custom"?T(p.message,p):a?a(p):external_React_namespaceObject.createElement(F,{toast:p,position:g}))}))};var _t=dist_n;
//# sourceMappingURL=index.mjs.map
;// CONCATENATED MODULE: ./src/admin/pages/settings/index.js




function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = settings_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
var CSS_PRINT_OPTIONS = [{
  label: (0,external_wp_i18n_namespaceObject.__)('Internal CSS', 'blockart'),
  value: 'internal-css',
  description: '<style>.blockart-blocks{color: red}</style>'
}, {
  label: (0,external_wp_i18n_namespaceObject.__)('External CSS File', 'blockart'),
  value: 'external-css-file',
  description: '<link rel="stylesheet" href="https://example.com/blockart.css">'
}];
/* harmony default export */ const settings = (function () {
  var _useState = (0,external_wp_element_namespaceObject.useState)({
    ...
    isRegenerating = _useState2$.isRegenerating,
    setState = _useState2[1];
  use_current_css_class('#toplevel_page_blockart a[href="admin.php?page=blockart#/settings"]');
  use_update_title((0,external_wp_i18n_namespaceObject.__)('BlockArt Blocks - Settings', 'blockart'));
  var updateSettings = function updateSettings() {
    ...
    external_wp_apiFetch_default()({
      ...
      _t.success((0,external_wp_i18n_namespaceObject.__)('Settings saved successfully!', 'blockart'), TOAST_OPTIONS);
    })["catch"](function (e) {
      _t.error("".concat(e.code, ": ").concat(e.message), TOAST_OPTIONS);
    })["finally"](function () {
      setState(function (prev) {
        return _objectSpread(_objectSpread({}, prev), {}, {
          isSaving: false
  ...
  var handleCSSRegeneration = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/external_regeneratorRuntime_default().mark(function _callee() {
      var id, postTypes, postType, index, posts, _iterator, _step, post;
      return external_regeneratorRuntime_default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            id = _t.loading((0,external_wp_i18n_namespaceObject.__)('Regenerating CSS for widgets and templates…', 'blockart'), _objectSpread({}, TOAST_OPTIONS));
            _context.prev = 2;
            _context.next = 5;
            return external_wp_apiFetch_default()({
              path: '/blockart/v1/regen-css',
              method: 'POST',
              data: {
                id: 0
              }
          ...
          case 7:
            ...
            postTypes = (0,external_lodash_namespaceObject.pick)(postTypes, ['post', 'page']);
            _context.t0 = external_regeneratorRuntime_default().keys(postTypes);
          case 10:
            if ((_context.t1 = _context.t0()).done) {
              _context.next = 40;
              break;
            }
            postType = _context.t1.value;
            index = 1;
            _context.next = 15;
            return external_wp_apiFetch_default()({
              path: "".concat(postTypes[postType].rest_namespace, "/").concat(postTypes[postType].rest_base, "?per_page=-1"),
              method: 'GET'
            });
          case 15:
            posts = _context.sent;
          ...
          case 18:
            /* Translators: 1: Name of post type, 2: Current post number, 3: Total number of post */
            _t.loading((0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject.__)('Regenerating CSS for %1$s %2$d of %3$d…', 'blockart'), postType, index, posts.length), {
              id: id
            });
          ...
          case 40:
            _t.dismiss(id);
            _t.success((0,external_wp_i18n_namespaceObject.__)('CSS regenerated successfully!', 'blockart'), TOAST_OPTIONS);
            _context.next = 48;
            break;
          case 44:
            _context.prev = 44;
            ...
            _t.dismiss(id);
            _t.error((0,external_wp_i18n_namespaceObject.__)('Error regenerating CSS', 'blockart'), TOAST_OPTIONS);
          case 48:
            setState(function (prev) {
              return _objectSpread(_objectSpread({}, prev), {}, {
                isRegenerating: false
      ...
      }, _callee, null, [[2, 44], [20, 32, 35, 38]]);
    }));
    return function handleCSSRegeneration() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    label: (0,external_wp_i18n_namespaceObject.__)('Dynamic CSS print method', 'blockart'),
    value: dynamicCSSPrintMethod,
    onChange: function onChange(v) {
      return setState(function (prev) {
        return _objectSpread(_objectSpread({}, prev), {}, {
          dynamicCSSPrintMethod: v
        });
      });
    },
    options: CSS_PRINT_OPTIONS,
    help: /*#__PURE__*/React.createElement(React.Fragment, null, CSS_PRINT_OPTIONS.map(function (option, i, options) {
      return /*#__PURE__*/React.createElement(external_wp_element_namespaceObject.Fragment, {
        key: option.value
      }, option.label + ' : ' + option.description, i < options.length - 1 && /*#__PURE__*/React.createElement("br", null));
    }))
  }), /*#__PURE__*/React.createElement(external_wp_components_namespaceObject.BaseControl, {
    help: (0,external_wp_i18n_namespaceObject.__)('Regenerate CSS for all posts, pages and widgets.', 'blockart')
  }, /*#__PURE__*/React.createElement(external_wp_components_namespaceObject.BaseControl.VisualLabel, null, (0,external_wp_i18n_namespaceObject.__)('Regenerate CSS', 'blockart')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(external_wp_components_namespaceObject.Button, {
    isSecondary: true,
    onClick: handleCSSRegeneration
  }, isRegenerating ? /*#__PURE__*/React.createElement(external_wp_components_namespaceObject.Spinner, null) : /*#__PURE__*/React.createElement("span", null, (0,external_wp_i18n_namespaceObject.__)('Regenerate', 'blockart'))))), /*#__PURE__*/React.createElement(external_wp_components_namespaceObject.Button, {
    isPrimary: true,
    className: "blockart-settings-save",
    disabled: isSaving || isRegenerating,
    "data-busy": isSaving ? true : null,
  ...
  }, (0,external_wp_i18n_namespaceObject.__)('Save Settings', 'blockart'))), /*#__PURE__*/React.createElement(Ie, null))));
});
;// CONCATENATED MODULE: ./src/admin/pages/index.js
...
(function (global) {
  var _global$wp$element = global.wp.element,
    createRoot = _global$wp$element.createRoot,
    render = _global$wp$element.render;
